...
#define MaxFitPointNum 100    //Max count of fitting Point
...
void main()
{
	Point3D FitPoint[10];
	Point3D C;
	float uk[MaxFitPointNum];
	float U[MaxFitPointNum];
	float u = 0;
	FitPoint[0].X = 0; FitPoint[0].Y = 0;
	FitPoint[1].X = 1; FitPoint[1].Y =1;
	FitPoint[2].X = 3; FitPoint[2].Y = 2;
	FitPoint[3].X = 4; FitPoint[3].Y = 2;
	FitPoint[4].X = 7; FitPoint[4].Y = 1;
	FitPoint[5].X = 8; FitPoint[5].Y = 0;
	FitPoint[6].X = 9; FitPoint[6].Y = -1;
	FitPoint[7].X = 11; FitPoint[7].Y = -2;
	FitPoint[8].X = 15; FitPoint[8].Y = -4;
	FitPoint[9].X = 19; FitPoint[9].Y = -5;

	getFitPointU(FitPoint, 10, 0, uk);
	getVectorU(10, uk, U);

	while (u<=1)
	{
		C=getCurvePoint(u, 10, U, FitPoint);
		u += 0.01;
		printf("X=%f,Y=%f \n", C.X, C.Y);
	}
}
